...
import kr.co.yogibaba.www.yogibaba.shoppingtab.lighting.LightingAdapter;
import kr.co.yogibaba.www.yogibaba.shoppingtab.lighting.LightingViewHolder;
...
public class LightingTabFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClicListener(new LightingViewHolder.OnItemClickListener(){
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_lighting_tab, container, false);
        recyclerView=(RecyclerView)view.findViewById(R.id.rv_shopping_light);
        ...
        gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) { //포지션에 따라 한칸을 차지할거냐 두칸을 차지할거냐
                ...
                if (type == LightingAdapter.VIEW_TYPE_RECYCLER) {
                    return 1;
                } else {
                    return 2;
                }
